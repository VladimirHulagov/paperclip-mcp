...
async def list_tools():
    return [
        ...
        types.Tool(
            ...
            description="Release (unlock) an issue. Only clears the checkout lock — does NOT change status or remove assignee. Use update_issue to change status or reassign.",
            inputSchema={
                "type": "object",
                "properties": {
                    "issueId": {"type": "string", "description": "Issue UUID or identifier"},
